...
public class msjcMockDsjccomTest6 {
	...
	public static void setUpDsCom() throws Exception {
		...
		FileUtils.copyDirectory(new File("..\\config\\csc\\de"), new File(
				"config\\csc\\de"));
	...
	public static void tearDownDsCom() throws Exception {
		...
		FileUtils.deleteDirectory(new File("config\\csc\\de"));
		FileUtils.deleteDirectory(new File("config\\csc\\dz"));
		FileUtils.deleteDirectory(new File("nullcsc"));
		//FileUtils.deleteDirectory(new File("waslogs"));
